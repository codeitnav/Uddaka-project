    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Column: Image */}
          <div className="relative w-full h-full justify-center lg:justify-start hidden lg:flex">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                Delivery is the future of business in this digital-focused
                world.
                <strong> Uddaka</strong> uses a powerful combination of
                technology and expert logistics partners to change the way
                companies connect and deliver.
              </p>
            </div>

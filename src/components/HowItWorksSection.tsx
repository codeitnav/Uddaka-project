  ...
  const steps = [
    {
      ...
      title: "Sign Up",
      description:
        "Register with your mobile number and basic profile details.",
    ...
    },
    {
      ...
      description:
        "Enter pickup & drop locations, select vehicle and load type.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${step.color} text-white mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
                {step.icon}
              </div>
